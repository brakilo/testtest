...
!function (t, e) {
    ...
    function h(t, e) {
        return !1 !== e.clone && e.isMergeableObject(t) ? d((i = t,
            ...
            getLabelText: function (t, e) {
                if (e) {
                    if ("function" == typeof e.render) {
                        var i = [];
                        return this.config && this.config.marker && i.push(this.config.marker),
                            i.push(t),
    ...
    var L = function (e) {
        function i(t) {
            ...
            return (i = e.call(this) || this).config = u,
    ...
    var O = function (e) {
        function i(t) {
            ...
            return (i = e.call(this) || this)._map = h,
        ...
        return t.prototype.render = function () {
            ...
            for (var a = 0; a < e.length; a++) {
                ...
                switch (this._series.config.attribute) {
                    case "fill":
                        t = e[a].value,
                            /\.(jpg|gif|png)$/.test(t) ? r.style.background = "url(" + e[a].value + ")" : r.style.background = e[a].value;
                        break;
                    case "stroke":
                        r.style.background = e[a].value;
                        break;
                    case "image":
                        r.style.background = "url(" + ("object" == typeof e[a].value ? e[a].value.url : e[a].value) + ") no-repeat center center",
        ...
        , Y = function () {
            function t(t, e, i) {
                void 0 === t && (t = {}),
                    ...
                    this.config.legend && (this.legend = new A(v({
                        map: this._map,
                        series: this
                    }, this.config.legend))),
    ...
    var T = {
        ...
        _setupElementEvents: function () {
            ...
            S.on(a, "mousemove", (function (s) {
                ...
                S.delegate(a, "mouseover mouseout", ".jvm-element", (function (t) {
                    ...
                    "mouseover" === t.type ? (e.element.hover(!0),
                        i && (s._tooltip.text(e.tooltipText),
                            s._tooltip.show(),
                            s._emit(e.event, [t, s._tooltip, e.code]))) : (e.element.hover(!1),
                                i && s._tooltip.hide())
                }
                )),
        ...
        _createRegions: function () {
            for (var t in this._regionLabelsGroup = this._regionLabelsGroup || this.canvas.createGroup("jvm-regions-labels-group"),
                this._mapData.paths) {
                var e = new C({
                    map: this,
                    code: t,
        ...
        _createLines: function (t, e, i) {
            ...
            var s = !1
                , a = !1;
            for (var n in this.linesGroup = this.linesGroup || this.canvas.createGroup("jvm-lines-group"),
                t) {
                var r = t[n];
                for (var o in e) {
        ...
        _createSeries: function () {
            for (var t in this.series = {
                ...
                for (var e = 0; e < this.params.series[t].length; e++)
                    this.series[t][e] = new Y(this.params.series[t][e], "markers" === t ? this._markers : this.regions, this)
        },
        _applyTransform: function () {
            var t, e, i, s;
            this._defaultWidth * this.scale <= this._width ? (t = (this._width - this._defaultWidth * this.scale) / (2 * this.scale),
                i = (this._width - this._defaultWidth * this.scale) / (2 * this.scale)) : (t = 0,
                    i = (this._width - this._defaultWidth * this.scale) / this.scale),
                this._defaultHeight * this.scale <= this._height ? (e = (this._height - this._defaultHeight * this.scale) / (2 * this.scale),
                    s = (this._height - this._defaultHeight * this.scale) / (2 * this.scale)) : (e = 0,
                        s = (this._height - this._defaultHeight * this.scale) / this.scale),
        ...
        _resize: function () {
            ...
            this._width / this._height > this._defaultWidth / this._defaultHeight ? (this._baseScale = this._height / this._defaultHeight,
                this._baseTransX = Math.abs(this._width - this._defaultWidth * this._baseScale) / (2 * this._baseScale)) : (this._baseScale = this._width / this._defaultWidth,
        ...
        _setScale: function (t, e, i, s, a) {
            ...
            t > this.params.zoomMax * this._baseScale ? t = this.params.zoomMax * this._baseScale : t < this.params.zoomMin * this._baseScale && (t = this.params.zoomMin * this._baseScale),
                void 0 !== e && void 0 !== i && (n = t / this.scale,
                    s ? (d = e + this._defaultWidth * (this._width / (this._defaultWidth * t)) / 2,
                        f = i + this._defaultHeight * (this._height / (this._defaultHeight * t)) / 2) : (d = this.transX - (n - 1) / t * e,
                ...
                a && v > 0 ? (o = this.scale,
                    ...
                    r = setInterval((function () {
                        ...
                        this._emit(k.onViewportChange, [this.scale, this.transX, this.transY]))
        },
        setFocus: function (t) {
            var e = this;
            void 0 === t && (t = {});
        ...
        coordsToPoint: function (t, e) {
            ...
            if (!r)
                return !1;
            var o = r.bbox;
            return a = (a - o[0].x) / (o[1].x - o[0].x) * r.width * this.scale,
        ...
        _repositionLines: function () {
            ...
            for (var i in this._lines) {
                for (var s in this._markers) {
                    ...
                    a.config.name === this._lines[i].config.from && (t = this.getMarkerPosition(a.config)),
                        a.config.name === this._lines[i].config.to && (e = this.getMarkerPosition(a.config))
                }
        ...
        , z = function () {
            function t(t, e) {
                this.node = this._createElement(t),
                    e && this.set(e)
            }
            var e = t.prototype;
        ...
        , P = function (e) {
            ...
            return s.setStyle = function (t, e) {
                var i;
                "object" == typeof t ? v(this.style.current, t) : v(this.style.current, ((i = {})[t] = e,
                    i));
                this.updateStyle()
            }
                ,
                s.updateStyle = function () {
                    ...
                    v(t, this.style.initial),
                        ...
                        this.isSelected && (v(t, this.style.selected),
        ...
        , I = function (e) {
            ...
            return t(i, e),
                i.prototype.applyAttr = function (t, i) {
                    var s;
                    "image" === t ? ("object" == typeof i ? (s = i.url,
                        ...
                        this.applyAttr("y", this.cy - this.height / 2 + this.offset[1])) : "cx" == t ? (this.cx = i,
                            this.width && this.applyAttr("x", i - this.width / 2 + this.offset[0])) : "cy" == t ? (this.cy = i,
                                this.height && this.applyAttr("y", i - this.height / 2 + this.offset[1])) : e.prototype.applyAttr.apply(this, arguments)
                }
                ,
                i
        }(P)
        , R = function (e) {
            function i(t) {
                var i;
                return (i = e.call(this, "svg") || this)._container = t,
                    i._defsElement = new z("defs"),
                    i._rootElement = new z("g", {
        ...
        , G = function () {
            function t(e) {
                ...
                this.regions = {},
                    ...
                    this._baseTransX = 0,
                    this._baseTransY = 0,
                    "loading" !== document.readyState ? this._init() : window.addEventListener("DOMContentLoaded", (function () {
                        return i._init()
                    }
                    ))
            }
            ...
            return e._init = function () {
                ...
                this.container = f(t.selector),
                    ...
                    t.visualizeData && (this.dataVisualization = new V(t.visualizeData, this)),
                    ...
                    t.series && (this.container.appendChild(this.legendHorizontal = m("div", "jvm-series-container jvm-series-h")),
                        this.container.appendChild(this.legendVertical = m("div", "jvm-series-container jvm-series-v")),
                        this._createSeries()),
                ...
                e.addMarkers = function (t) {
                    if (Array.isArray(t))
                        return this._createMarkers(t, !0);
                ...
                e.removeLine = function (t, e) {
                    ...
                    var i = _(t, e);
                    this._lines.hasOwnProperty(i) && (this._lines[i].element.remove(),
                ...
                e.reset = function () {
                    ...
                    this.legendHorizontal && (g(this.legendHorizontal),
                        this.legendHorizontal = null),
                        this.legendVertical && (g(this.legendVertical),
                ...
                e.destroy = function (t) {
                    ...
                    void 0 === t && (t = !0),
                        ...
                        t && Object.keys(this).forEach((function (t) {
                            try {
                                delete e[t]
                            } catch (t) { }
                        }
                ...
                e.extend = function (e, i) {
                    if ("function" == typeof this[e])
                        throw new Error("The method [" + e + "] does already exist, please use another name.");
                    t.prototype[e] = i
                }
                ,
                e._emit = function (t, e) {
                    for (var i in k)
                        k[i] === t && "function" == typeof this.params[i] && this.params[i].apply(this, e)
                }
                ,
